...
(5) 在第二行后(亦即是加在第三行)加上『drink tea?』字样！
...
(6)那如果是要在第二行前加上『drink tea?』字样！

nl /etc/passwd | sed '2i drink tea' 

(7) 如果是要增加两行以上，在第二行后面加入两行字，例如 Drink tea or ..... 与 drink beer?
...
zhihu-
weibo-:q:q
(17) 利用 sed 直接在 regular_express.txt 最后一行加入 # This is a test:
